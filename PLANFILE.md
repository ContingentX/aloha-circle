...
| Dir | What | Stack |
|-----|------|-------|
| `/www` | Public website: visitor/local/nonprofit signup, live needs feed, match reveal | Vite + React, static build → S3 + CloudFront (Route 53: alohalive.net, already provisioned) |
...
4. **Deploy** `/www` build to the S3 bucket behind alohalive.net.
